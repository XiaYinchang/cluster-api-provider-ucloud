...
var _ = Describe("UCloudMachineReconciler", func() {
	BeforeEach(func() {})
	AfterEach(func() {})

	Context("Reconcile an UCloudMachine", func() {
		It("should not error with minimal set up", func() {
			...
			instance := &infrav1.UCloudMachine{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
